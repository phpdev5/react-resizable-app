...
var Resizable = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.resizeHandler = function resizeHandler(handlerName, axis) {
    ...
    return function (e, _ref2) {
      ...
      var height = _this2.props.height + (canDragY ? deltaY / _this2.props.transformScale : 0); //Custom code

      var oldWidth = width;
      var oldHeight = height; // Run user-provided constraints.

      var _this2$runConstraints = _this2.runConstraints(width, height);

      width = _this2$runConstraints[0];
      height = _this2$runConstraints[1];
      //If NaN, use actual value - this is because of auto margin cases
      if (isNaN(width)) width = oldWidth;
      if (isNaN(height)) height = oldHeight;
